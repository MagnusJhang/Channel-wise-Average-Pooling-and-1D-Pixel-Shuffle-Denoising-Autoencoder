...
class CPDAE_Full(nn.Module):
    def __init__(self):
        super(CPDAE_Full, self).__init__()
        ...
        self.short_pwconv.add_module("chwp_pwconv5", nn.Conv1d(1, 128, 1))
        ...
        self.short_pwconv.add_module("chwp_pwconv4", nn.Conv1d(1, 128, 1))
        ...
        self.short_pwconv.add_module("chwp_pwconv3", nn.Conv1d(1, 128, 1))
        ...
        self.short_pwconv.add_module("chwp_pwconv2", nn.Conv1d(1, 128, 1))
        ...
        self.short_pwconv.add_module("chwp_pwconv1", nn.Conv1d(1, 128, 1))
        ...
        self.CWAP = nn.Conv1d(128, 1, 1, bias=False)
        self.CWAP.weight.data.fill_(1 / 128)
