...
class CPDAE_Regular(nn.Module):
    def __init__(self):
        super(CPDAE_Regular, self).__init__()
        ...
        self.short_pwconv.add_module("short_pwconv6", nn.Conv1d(1, 32, 1))
        ...
        self.short_pwconv.add_module("short_pwconv5", nn.Conv1d(1, 32, 1))
        ...
        self.short_pwconv.add_module("short_pwconv4", nn.Conv1d(1, 32, 1))
        ...
        self.short_pwconv.add_module("short_pwconv3", nn.Conv1d(1, 32, 1))
        ...
        self.short_pwconv.add_module("short_pwconv2", nn.Conv1d(1, 32, 1))
        ...
        self.short_pwconv.add_module("short_pwconv1", nn.Conv1d(1, 32, 1))
        ...
        self.CWAP = nn.Conv1d(32, 1, 1, bias=False)
        self.CWAP.weight.data.fill_(1 / 32)
    ...
    def forward(self, x):
        ...
        """decoder"""
        x = self.decode_stage[0](x) # decoder7, no need to add the tensor from cwap
    ...
    def get_model_net(self):
        return "CPDAE_Regular"


if __name__ == "__main__":
    model = CPDAE_Regular().cuda()
